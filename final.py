...
plt.plot(range(num_epochs), D_lego_loss, label="Discriminator Loss (D_loss)", color='r')
plt.plot(range(num_epochs), D_face_loss, label="Generator Loss (G_loss)", color='g')
